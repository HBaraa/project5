...
class Home:
    """Dans cette classe, l'utilisateur est demandé de choisir soit aller aux catégoris ou quitter le programme"""
    def display(self):
        print("Bienvenue !")
...
class Categories:
    """cette classe sert à afficher toutes les catégories et à demander aux utilisateur de choisir une en entrant son identifiant
...
class Products:
    """Cette classe sert à afficher tous les produits qui appartiennent à la catégorie choisie et à demander à l'utilisateur de choisir un produit,
    aprés, elle permet d'afficher les détails de ce prosuit et elle retourne un appel de la commande SubstitutesCommand"""
...
class Substitutes:
    """Cette classe sert à afficher le substitut du produit et retoune un appel de commande SaveSubstituteCommand"""
...
class SaveSubstitute:
    """Dans cette classe, l'utilisateur est demandé de choisir entre voir ses favoris, chercher le substitut d'un autre prosuit ou quitter l'application"""
    def __init__(self):
        self.interfacing = Interface_diplay()
...
class DisplayFavoris:
    """Cette classe sert à afficher les les favoris sauvegerdés dans la table favorite"""
    def __init__(self):
        self.interfacing = Interface_diplay()
